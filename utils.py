...
def apply_theme_css():
    ...
    <style>
        ...
        * {{
        ...
        /* Enhanced sidebar styling with glassmorphism effect */
        section[data-testid="stSidebar"] {{
            background: linear-gradient(135deg, rgba(46, 204, 113, 0.15), rgba(52, 152, 219, 0.15)) !important;
        ...
        section[data-testid="stSidebar"] button {{
            background: linear-gradient(45deg, rgba(46, 204, 113, 0.8), rgba(52, 152, 219, 0.8)) !important;
            border: none !important;
        ...
        section[data-testid="stSidebar"] button:hover {{
            ...
            background: linear-gradient(45deg, rgba(46, 204, 113, 0.9), rgba(52, 152, 219, 0.9)) !important;
        }}
    </style>
    """
